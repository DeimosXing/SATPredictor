...
datadir = 'satzilla12features_final'
# datatype = 'satzilla12'
...
merged_df['dataset'] = merged_df['cnfname'].apply(lambda name: name.split('_')[0] if 'sc14' in name else name.split('/')[0])
...
merged_df.to_csv('satzilla12features-final.csv',index=False)
